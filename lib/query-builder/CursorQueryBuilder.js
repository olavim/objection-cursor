...
const {addOperation, setOperations, clearOperations, cloneOperations, hasOperation} = require('../operations/utils');
...
module.exports = function (options, Base) {
	return class extends Base {
		cursorPage(...args) {
			return addOperation(this, new CursorPageOperation(options), args);
		}
		...
		orderBy(...args) {
			return addOperation(this, new OrderByOperation(), args);
		}
